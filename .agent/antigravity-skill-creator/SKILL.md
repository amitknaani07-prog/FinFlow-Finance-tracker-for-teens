...
description: Expert system for generating high-quality .agent/skills/ directories with SKILL.md, scripts, and examples. Use this when the user needs to automate a routine or define complex agent behavior patterns.
---

# Antigravity Skill Creator

## When to use this skill
- Creating a new skill directory (`.agent/skills/`).
- Defining technical instructions for specific agent behaviors.
- Automating repetitive workflows via skill-based orchestration.

## Workflow
1. [ ] Identify the core requirement and "gerund-name".
2. [ ] Define the skill architecture (SKILL.md, scripts, examples).
3. [ ] Generate YAML frontmatter according to standards.
4. [ ] Write SKILL.md body using conciseness and progressive disclosure.
5. [ ] Provide the output in the specified template.
